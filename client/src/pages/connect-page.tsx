...
export default function ConnectPage() {
  ...
  const handleSendMessage = () => {
    ...
    if (activeSubTab === "messages" && selectedMessageId) {
      toast({
        title: "Message sent",
        description: "Your message has been sent.",
      });
      setNewMessage("");
    } else if (activeSubTab === "discussions" && selectedGroupId) {
      toast({
    ...
    <div className="container mx-auto px-4 lg:px-6 py-8">
      <div className="flex flex-col space-y-8">
        ...
        <Tabs 
          ...
          className="w-full"
        >
          <TabsList className="grid w-full max-w-md grid-cols-2 bg-[#EAF2EF]">
            <TabsTrigger 
              value="discover" 
          ...
          <TabsContent value="discover" className="pt-6 px-0">
            ...
            >
              <TabsList className="grid w-full max-w-md grid-cols-2">
                <TabsTrigger 
                  value="discussions" 
                  className="flex items-center gap-2 hover:bg-[#EAF2EF] transition-colors data-[state=active]:bg-white data-[state=active]:text-[#09261E] data-[state=active]:border-b-2 data-[state=active]:border-[#09261E] rounded-none"
                >
          ...
          <TabsContent value="my-content" className="pt-6 px-0">
            ...
            >
                    ...
                    {myGroups.map(group => (
                      <Card key={group.id} className="overflow-hidden border border-gray-200 hover:border-[#09261E] transition-colors duration-200">
                        ...
                        <CardFooter className="border-t p-4">
                          <Button 
                            variant="outline"
                            className="w-full border-[#09261E] text-[#09261E] hover:bg-[#EAF2EF]"
                            onClick={() => toggleJoinGroup(group.id)}
                          >
                            Leave Group
                          </Button>
                  ...
                  <div className="grid gap-6 md:grid-cols-1">
                    <Card className="overflow-hidden border border-gray-200">
                      <CardHeader className="p-4 flex flex-row items-center justify-between bg-[#F7F8FA] border-b">
                        ...
                        <Button 
                          variant="outline"
                          className="border-[#09261E] text-[#09261E] hover:bg-[#EAF2EF]"
                          onClick={() => toggleJoinGroup(selectedGroup!.id)}
                        >
                          Leave Group
                        </Button>
              ...
              {/* My Messages Content - Same as Messages in Discover tab */}
              <TabsContent value="messages" className="pt-6">
                <div className="grid gap-6 md:grid-cols-3">
                  {/* Conversations sidebar */}
                  <div className="md:col-span-1 border rounded-lg overflow-hidden">
                    <div className="p-3 border-b bg-[#F7F8FA]">
                      <h3 className="text-lg font-semibold text-[#09261E]">My Conversations</h3>
                    </div>
                    <div className="divide-y">
                      {filteredMessages.length > 0 ? (
                        filteredMessages.map(message => (
